        ...
        PageControlNavigator: WinJS.Class.define(
            ...
            function PageControlNavigator(element, options) {
                ...
                WinJS.Navigation.back = function (distance) {
                    history.go(-parseInt(distance || 1))
                } // the idea is to make everything go to angular router
            ...
            if (next) {
              ...
              if (angular.isDefined(template = next.template)) {
                ...
                if (angular.isDefined(templateUrl)) {
                  ...
                  // hack  winjs : we dont need to load content anymore, winjs will do it
                  // instead we just give the template url so that ng view can know it
...
function ngViewFillContentFactory($compile, $controller, $route) {
  return {
    ...
    link: function(scope, $element) {
      ...
      //hack to use winjs nav system
      $element.attr('data-win-control', 'Application.PageControlNavigator')
      WinJS.UI.process($element[0]).then(function () {
          WinJS.Navigation.navigate(locals.$template, WinJS.Navigation.state).then(function () {
